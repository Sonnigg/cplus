...
static void usage(void)
{
    ...
    printf(
        ...
        "  -g            Generate runtime debug info (forwarded to TCC)\n"
        "  -b            Compile with built-in memory and bounds checker (implies -g, forwarded to TCC)\n"
        "  -L<dir>       Add library path 'dir' (forwarded to TCC)\n"
        "  -l<lib>       Link with dynamic or static library 'lib' (forwarded to TCC)\n"
